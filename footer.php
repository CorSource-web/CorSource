		...
		<div class="footer-wrapper container">
			...
			<div class="footer-wrapper__top">
				...
				<div class="right">
					<div class="headquarters">
						<h5>Headquarters</h5>
						<a target="_blank" href="http://maps.google.com/?q=9115 SW Oleson Rd, Ste 100, Portland, OR 97223">
					...
					<div class="explore">
						...
						<a href="<?php echo home_url() . '/employee-login'; ?>">
							<p class="minor bold">Employee Login</p>
						</a>
						<a href="<?php echo home_url() . '/jobs'; ?>">
							<p class="minor bold">Job Seekers</p>
						</a>
						<div class="social-wrapper">
			
							<a target="_blank" href="https://www.linkedin.com/company/corsource-technology-group/"><img class="social" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/footer/facebook-white.png" /></a>
						</div>
			...
			<div class="footer-wrapper__bottom">
				...
				<div class="bottom-right">
					<p class="minor">© <?php echo date('Y'); ?> CorSource Technology Group LLC</p>
					<a href="<?php echo home_url() . '/privacy'; ?>">
						<p class="privacy minor">Privacy</p>
					</a>
...
<!-- <script type="text/javascript" id="hs-script-loader" async defer src="[//js.hs-scripts.com/40109439.js](notion://js.hs-scripts.com/40109439.js)"></script> -->
