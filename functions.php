...
function custom_inline_script() {
    echo '<script>
            ...
            lines.forEach(function(line) {
                if (line.trim() !== \'\') {
                    ...
                    line = line.replace(urlRegex, function(url) {
                        return \'<a href="\' + url + \'" target="_blank" style="font-size: 16px; font-family: \\\'Inter\\\', sans-serif; color: #d64936;">\' + url + \'</a>\';
                    });
        ...
        console.log(\'MutationObserver started. Waiting for label...\');
    </script>';
}
